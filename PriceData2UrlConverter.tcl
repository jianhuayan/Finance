...
return $Url_rtn_converted
} 

set filename_dnld ~jyan/Finance/sandbox/Price.csv 
set filename_conv "~jyan/Finance/sandbox/Price_conv" 
set filename_conv_ID [open $filename_conv "w"]
...
set new_line [Url_Converter $line]
# puts -nonewline $filename_conv_ID $new_line
puts $filename_conv_ID $new_line
}
close $filename_conv_ID
